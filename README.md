...
__str__(herdado):
Exibe as informações do duelo, incluindo:

treinadores;
Pokémon dos dois times;
combates realizados;
vencedor.
...
times()
escolher 6 pokemonse os coloca em 2 times. Acessa o DAO de pokemons e pesquisa por um id
e verifica se o id existe
